  ...
  return (
    ...
    >
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8  ">
        <div className="mx-auto max-w-lg p-4 shadow-lg  rounded-xl bg-gradient-to-r from-black via-gray-800 to-yellow-500bg-gradient-to-r from-black via-gray to-black">
